...
public class ConjurBuildFeature extends AgentLifeCycleAdapter {
    ...
    public ConjurParametersResolver parametersResolver;

    public ConjurBuildFeature(EventDispatcher<AgentLifeCycleListener> dispatcher, SSLTrustStoreProvider trustStoreProvider, ConjurParametersResolver myConjurParametersResolver) {
        this.dispatcher = dispatcher;
        this.trustStoreProvider = trustStoreProvider;
        this.dispatcher.addListener(this);
        this.parametersResolver = myConjurParametersResolver;
    }
    ...
    public void buildStarted(AgentRunningBuild runningBuild) {
        ...
        // TODO: I think we should use this logger to output the verbose logs,
        //   this will allow the user to debug the issue without the ability to gain access to the agent logs
        ...
        for(Map.Entry<String, String> kv : conjurVariables.entrySet()) {
            ...
            logger.Verbose(String.format("Setting secret '%s' with id '%s'", envVar, kv.getValue()));
